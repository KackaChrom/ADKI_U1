...
class Algorithms:
    ...
    def windingNumber(self, q:QPointF, pol:QPolygonF):
        ...
        for i in range(n):
            ...
            #w_i - Law of cosines 
            if(l_qi == 0 or l_qi1 == 0 or ((l_qi*l_qi + l_qi1*l_qi1 - l_ii1*l_ii1)/(2*l_qi*l_qi1)) > 1 or ((l_qi*l_qi + l_qi1*l_qi1 - l_ii1*l_ii1)/(2*l_qi*l_qi1)) < -1):
                V==5
            else:
                w_i = acos((l_qi*l_qi + l_qi1*l_qi1 - l_ii1*l_ii1)/(2*l_qi*l_qi1))
